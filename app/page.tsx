...
function AnimatedSection({ children, id }: { children: React.ReactNode; id: string }) {
  return (
    <motion.section
      ...
      className="py-8 sm:py-12 md:py-16 lg:py-20 bg-white/80 backdrop-blur-sm rounded-lg my-4"
      id={id}
    >
      {children}
    </motion.section>
    ...
    <div className="min-h-screen bg-gradient overflow-x-hidden">
      ...
      <div className="relative">
        <main className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-screen flex flex-col justify-center items-center py-12 sm:py-16 md:py-20 ">
